...
namespace MiniShop.Business.Abstract
{
    public interface ICategoryService
    {
        ...
        Task<Response<List<CategoryDTO>>> GetNonDeletedCategoriesAsync();
        ...
        Task<Response<List<CategoryDTO>>> GetAllCategoriesActiveDeletedAsync(bool? isActive = null, bool? isDeleted = null);
