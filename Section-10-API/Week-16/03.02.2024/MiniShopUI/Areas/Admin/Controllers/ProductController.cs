...
namespace MiniShop.MVC.Areas.Admin.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public async Task<IActionResult> Create(AddProductViewModel model, IFormFile image)
        {
            ...
            if(ModelState.IsValid && model.CategoryIds.Count>0 && image != null)
            {
                ...
                using (var httpClient = new HttpClient())
                {
                    ...
                    using (var stream =  image.OpenReadStream())
                    {
                        ...
                        HttpResponseMessage httpResponseMessage = await httpClient.PostAsync("http://localhost:7700/products/UploadImage", imageContent);
            ...
            ViewBag.CategoryErrorMessage = model.CategoryIds.Count == 0 ? "En az 1 kategori seçmeden ürün kaydı yapılamaz." : null;
