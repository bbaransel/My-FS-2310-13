...
namespace MiniShop.Business.Concrete
{
    public class MessageManager : IMessageService
    {
        ...
        public async Task<Response<List<MessageViewModel>>> GetAllRecivedMessageAsync(string toUserId)
        {
        ...
        public async Task<Response<int>> GetMessageCountAsync(string userId, bool isRead)
        {
