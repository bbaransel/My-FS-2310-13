...
namespace MiniShop.UI.Controllers
{
    ...
    public class MessageController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var response = await _messageManager.GetAllRecivedMessageAsync(userId);
        ...
        public async Task<IActionResult> NewMessage(MessageViewModel model)
        {
            ...
            if (result.IsSucceeded) _notyfManager.Success("Mesaj başarıyla gönderildi");
            else _notyfManager.Error("Mesaj gönderilemedi.");
        ...
        public async Task<IActionResult> ReadMessage(int id)
        {
            ...
            await _messageManager.MakeReadAsync(id);
            return View(message);
        }
    }
}
